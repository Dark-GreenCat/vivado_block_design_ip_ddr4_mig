...
//--------------------------------------------------------------------------------
//Command: generate_target bd_021b.bd
//Design : bd_021b
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_021b,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_021b,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "memory_system_ddr4_0_0_microblaze_mcs.hwdef" *) 
module bd_021b
   (Clk,
    IO_addr_strobe,
    IO_address,
    ...
    TRACE_reg_write,
    TRACE_valid_instr);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_ASYNC_RESET Reset, CLK_DOMAIN bd_021b_Clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input Clk;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 >  bd_021b lmb_bram_I bd_021b second_lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_021b_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_021b_ilmb_cntlr_0 ilmb_cntlr
  ...
  bd_021b_iomodule_0_0 iomodule_0
       (.Clk(Clk2),
  ...
  bd_021b_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_021b dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_021b_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk2),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_021b_second_dlmb_cntlr_0 second_dlmb_cntlr
  ...
  bd_021b_second_ilmb_cntlr_0 second_ilmb_cntlr
  ...
  bd_021b_second_lmb_bram_I_0 second_lmb_bram_I
