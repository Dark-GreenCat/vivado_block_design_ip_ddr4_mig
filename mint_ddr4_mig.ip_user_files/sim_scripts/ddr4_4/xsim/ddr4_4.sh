...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L microblaze_v11_0_13 -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_15 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_24 -L blk_mem_gen_v8_4_8 -L iomodule_v3_1_10 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ddr4_4 xil_defaultlib.ddr4_4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ddr4_4 -key {Behavioral:sim_1:Functional:ddr4_4} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_a064.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ddr4_4.wdb xsim.dir libdpi.so)
