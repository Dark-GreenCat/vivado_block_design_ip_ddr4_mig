...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L microblaze_v11_0_13 -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_15 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_24 -L blk_mem_gen_v8_4_8 -L iomodule_v3_1_10 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_31 -L axi_vip_v1_1_17 -L xlconstant_v1_1_9 -L dist_mem_gen_v8_0_15 -L lib_bmg_v1_0_17 -L axi_traffic_gen_v3_0_17 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot memory_system xil_defaultlib.memory_system xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim memory_system -key {Behavioral:sim_1:Functional:memory_system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_a064.protoinst" -protoinst "protoinst_files/bd_021b.protoinst" -protoinst "protoinst_files/bd_ee24.protoinst" -protoinst "protoinst_files/memory_system.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/huy_k66/apps/tools/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb memory_system.wdb xsim.dir libdpi.so)
