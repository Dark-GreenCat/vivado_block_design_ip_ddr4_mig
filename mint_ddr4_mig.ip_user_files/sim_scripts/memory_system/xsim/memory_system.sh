...
simulate()
{
  xsim memory_system -key {Behavioral:sim_1:Functional:memory_system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_021b.protoinst" -protoinst "protoinst_files/bd_ee24.protoinst" -protoinst "protoinst_files/memory_system.protoinst" -protoinst "protoinst_files/bd_a064.protoinst" -log simulate.log
}
